        ...
        $_inputObject | ForEach-Object {
            ...
            if (!$_item) {
                if ($PSBoundParameters['Name']) {
                    Write-Error -Exception ([System.Management.Automation.ItemNotFoundException]::New("Cannot find Quick access item with the name '$($_)'.")) -Category ObjectNotFound -TargetObject $_
                    return
                }
                elseif ($PSBoundParameters['Path']) {
                    Write-Error -Exception ([System.Management.Automation.ItemNotFoundException]::New("Cannot find Quick access item with the path '$($_)'.")) -Category ObjectNotFound -TargetObject $_
                    return
                }
            }
            $_item
